...
namespace GameRes
{
    ...
    {
        public InvalidFormatException() : base(Localization._T ("MsgInvalidFormat")) { }
        public InvalidFormatException (string msg) : base (msg) { }
    }

    public class UnknownEncryptionScheme : Exception
    {
        public UnknownEncryptionScheme() : base(Localization._T ("MsgUnknownEncryption")) { }
        public UnknownEncryptionScheme (string msg) : base (msg) { }
    }

    public class InvalidEncryptionScheme : Exception
    {
        public InvalidEncryptionScheme() : base(Localization._T ("MsgInvalidEncryption")) { }
        public InvalidEncryptionScheme (string msg) : base (msg) { }
    }

    public class FileSizeException : Exception
    {
        public FileSizeException () : base (Localization._T ("MsgFileTooLarge")) { }
    ...
    public class InvalidFileName : Exception
    {
        ...
        public InvalidFileName (string filename)
            : this (filename, Localization._T ("MsgInvalidFileName"))
        {
        }
        ...
        public InvalidFileName (string filename, Exception X)
            : this (filename, Localization._T ("MsgInvalidFileName"), X)
        {
        }
