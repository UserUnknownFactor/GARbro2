...
namespace GameRes.Formats.Amaterasu
{
    ...
    public class AmiOpener : ArchiveFormat
    {
        ...
        public override string Description { get { return Localization._T ("AMIDescription"); } }
                                     ...
                                     EntryCallback callback)
        {
            ...
            try
            {
                ...
                if (0 == update_count)
                    throw new InvalidFormatException (Localization._T ("AMINoFiles"));
                ...
                {
                    if (null != callback)
                        callback (callback_count++, entry.Value, Localization._T ("MsgAddingFile"));
        ...
        uint WriteImageEntry (PackedEntry entry, IBinaryStream input, Stream output)
        {
            ...
            using (var zstream = new ZLibStream (output, CompressionMode.Compress, CompressionLevel.Level9, true))
            {
                ...
                else
                {
                    ...
                    if (null == image)
                        throw new InvalidFormatException (string.Format (Localization._T ("MsgInvalidImageFormat"), entry.Name));
    ...
    public class ScrFormat : GenericScriptFormat
    {
        ...
        public override string Description { get { return  Localization._T ("SCRDescription"); } }
