...
namespace GameRes.Formats.NitroPlus
{
    ...
    public class NpaOpener : ArchiveFormat
    {
        ...
        public override string Description { get { return Localization._T ("NPADescription"); } }
        ...
        public override ArcFile TryOpen (ArcView file)
        {
            ...
            if (encrypted)
            {
                ...
                if (null == enc)
                    throw new OperationCanceledException (Localization._T ("MsgUnknownEncryption"));
                game_id = enc.TitleId;
            }
        ...
        EncryptionScheme QueryGameEncryption (string arc_name)
        {
            ...
            if (null == scheme)
            {
                var options = Query<NpaOptions> (Localization._T ("ArcEncryptedNotice"));
    ...
    internal class Indexer
    {
        ...
        public Indexer (IEnumerable<Entry> source_list, NpaOptions options)
        {
            ...
            foreach (var entry in source_list)
            {
                ...
                {
                    throw new InvalidFileName (name, Localization._T ("MsgIllegalCharacters"), X);
                }
            }
        }
